...
const SvgComponent = ({
  ...
  <svg width='24' height='24' viewBox='0 0 24 24' fill='none'>
    <path
      d='M3 6.29999V20.5C3 20.7652 3.10536 21.0196 3.29289 21.2071C3.48043 21.3946 3.73478 21.5 4 21.5H20C20.2652 21.5 20.5196 21.3946 20.7071 21.2071C20.8946 21.0196 21 20.7652 21 20.5V6.29999H3Z'
      stroke='black'
      strokeWidth='1.5'
